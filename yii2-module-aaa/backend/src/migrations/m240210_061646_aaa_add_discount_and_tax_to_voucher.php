...
class m240210_061646_aaa_add_discount_and_tax_to_voucher extends Migration
{
	public function safeUp()
	{
    $this->execute(<<<SQL
ALTER TABLE `tbl_AAA_Voucher`
	CHANGE COLUMN `vchDiscountAmount` `vchItemsDiscounts` DOUBLE UNSIGNED NULL DEFAULT NULL AFTER `vchAmount`,
	ADD COLUMN `vchItemsVATs` DOUBLE UNSIGNED NULL DEFAULT NULL AFTER `vchItemsDiscounts`;
SQL
    );
...
SQL
	...
	{
		echo "m240210_061646_aaa_add_discount_and_tax_to_voucher cannot be reverted.\n";
		return false;
	}
