...
class m230619_090419_aaa_add_usrMustChangePassword_to_tbl_user extends Migration
{
...
SQLSTR
	...
	{
		echo "m230619_090419_aaa_add_usrMustChangePassword_to_tbl_user cannot be reverted.\n";
		return false;
	}
