...
implements RestClientQueryInterface
{
    ...
    public function restPost(RestClientActiveRecord $model)
    {
        ...
        $apiResponse = $this->_request(
            ...
            'post',
            /* url        */
            $this->_getUrl('element', $model->getParentKey()),
            /* urlParams  */
            null,
            /* bodyParams */
            $bodyParams,
    ...
    public function restDelete(RestClientActiveRecord $model)
    {
        $apiResponse = $this->_request(
            ...
            'delete',
            /* url        */
            $this->_getUrl('element', $model->getPrimaryKey()),
            /* urlParams  */
            $model->getAttributes()
            /* bodyParams */
            /* formFiles  */
    ...
    */
    ...
    protected function _populate(
        ...
        $fnFormatMessage = function ($message) use ($messageCategory) {
            ...
            $mcat = $messageCategory;
            if (isset($message['i18n-cat'])) {
                $mcat = $message['i18n-cat'];
                unset($message['i18n-cat']);
            }
            ...
            $message = Yii::t($mcat, $msg, $message);
    ...
    protected function _unserializeResponseBody($apiResponse)
    {
        ...
        try {
            if (
                false !== stripos($contentType, $this->dataType)
