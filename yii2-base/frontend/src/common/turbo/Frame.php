...
namespace shopack\base\frontend\common\turbo;
...
class Frame extends Widget
{
     ...
     * @see \shopack\base\frontend\common\helpers\Html::renderTagAttributes() for details on how attributes are being rendered.
     */
